...
assert "name: openai-compatible"         "grep -q 'openai-compatible' /tmp/t1/opencode.jsonc"
assert "correct baseUrl"                 "grep -q 'gateway.default.svc' /tmp/t1/opencode.jsonc"
assert "model name in models array"      "grep -q 'claude-sonnet-4-5' /tmp/t1/opencode.jsonc"
