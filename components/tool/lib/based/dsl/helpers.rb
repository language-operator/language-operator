...
module Based
  ...
  module Helpers
    ...
    #
    # @example
    #   validate_url("https://example.com")  # => nil (valid)
    #   validate_url("not-a-url")            # => "Error: Invalid URL..."
    def validate_url(url)
      return "Error: Invalid URL. Must start with http:// or https://" unless url =~ /^https?:\/\//
      nil
    end
    ...
    #
    # @example
    #   validate_phone("+14155551234")  # => nil (valid)
    #   validate_phone("555-1234")      # => "Error: Invalid phone..."
    ...
    #
    # @example
    #   validate_email("user@example.com")  # => nil (valid)
    #   validate_email("invalid")           # => "Error: Invalid email format"
