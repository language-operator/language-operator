    ...
    return (
      <AuthenticatedLayout>
        <NotFound
          ...
          onBack={() => router.push(`/clusters/${clusterName}/tools`)}
        ...
        <ResourceHeader
          ...
          actions={
            <>
              <Button
                variant="outline"
                onClick={() => router.push(`/clusters/${clusterName}/tools/${toolName}/edit`)}
              >
        ...
        <Tabs value={getCurrentTabValue(pathname, clusterName, toolName)}>
          <TabsList className="w-full">
            <TabsTrigger value="overview" asChild>
              <Link href={`/clusters/${clusterName}/tools/${toolName}`}>
                <Home className="w-4 h-4 mr-2" />
                Overview
              </Link>
            </TabsTrigger>
            <TabsTrigger value="logs" asChild>
              <Link href={`/clusters/${clusterName}/tools/${toolName}/logs`}>
