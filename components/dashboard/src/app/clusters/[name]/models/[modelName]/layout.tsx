    ...
    return (
      <AuthenticatedLayout>
        <NotFound
          ...
          onBack={() => router.push(`/clusters/${clusterName}/models`)}
        ...
        <ResourceHeader
          ...
          actions={
            <>
              <Button
                variant="outline"
                onClick={() => router.push(`/clusters/${clusterName}/models/${modelName}/edit`)}
              >
        ...
        <Tabs value={getCurrentTabValue(pathname, clusterName, modelName)}>
          <TabsList className="w-full">
            ...
            <TabsTrigger value="details" asChild>
              <Link href={`/clusters/${clusterName}/models/${modelName}/details`}>
            ...
            <TabsTrigger value="logs" asChild>
              <Link href={`/clusters/${clusterName}/models/${modelName}/logs`}>
