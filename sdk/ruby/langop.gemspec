...
require_relative 'lib/langop/version'

Gem::Specification.new do |spec|
  spec.name          = 'langop'
  spec.version       = Langop::VERSION
  spec.authors       = ['Language Operator Team']
  spec.email         = ['noreply@langop.io']

  spec.summary       = 'Ruby SDK for building MCP tools and language agents'
  spec.description   = 'A comprehensive Ruby SDK for creating Model Context Protocol (MCP) tools and autonomous language agents with a clean DSL'
