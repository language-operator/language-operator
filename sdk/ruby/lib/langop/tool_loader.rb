...
module Langop
  ...
  #   loader = Langop::ToolLoader.new(registry, '/mcp/tools')
  #   loader.load_tools
  #   puts "Loaded #{registry.all.length} tools"
  #
  # @example With custom context
  #   loader = Langop::ToolLoader.new(registry)
  #   loader.load_tools
  #   loader.reload  # Hot reload tools
  class ToolLoader
    # Initialize tool loader
    #
    # @param registry [Langop::Dsl::Registry] Tool registry
    ...
    def load_tool_file(file)
      ...
      begin
        context = Langop::Dsl::Context.new(@registry)
        code = File.read(file)
