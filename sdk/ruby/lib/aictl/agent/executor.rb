...
module Aictl
  module Agent
    ...
    class Executor
      include Aictl::Loggable

      attr_reader :agent, :iteration_count

      # Initialize the executor
      #
      # @param agent [Aictl::Agent::Base] The agent instance
      ...
      # @param agent_definition [Aictl::Dsl::AgentDefinition, nil] Optional agent definition with workflow
      ...
      #
      # @param agent_def [Aictl::Dsl::AgentDefinition] The agent definition
