...
module Aictl
  ...
  #   loader = Aictl::ToolLoader.new(registry, '/mcp/tools')
  #   loader.load_tools
  #   puts "Loaded #{registry.all.length} tools"
  #
  # @example With custom context
  #   loader = Aictl::ToolLoader.new(registry)
  #   loader.load_tools
  #   loader.reload  # Hot reload tools
  class ToolLoader
    # Initialize tool loader
    #
    # @param registry [Aictl::Dsl::Registry] Tool registry
    ...
    def load_tool_file(file)
      ...
      begin
        context = Aictl::Dsl::Context.new(@registry)
        code = File.read(file)
