...
module Aictl
  ...
  module Dsl
    class << self
      ...
      #
      # @example
      #   Aictl::Dsl.load_file("mcp/tools.rb")
      ...
      #
      # @example
      #   Aictl::Dsl.load_agent_file("agents/news-summarizer.rb")
      ...
      #
      # @example
      #   server = Aictl::Dsl.create_server(server_name: "my-tools")
